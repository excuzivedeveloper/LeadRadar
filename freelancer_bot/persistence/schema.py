...
owner_source_candidate_notifications = sa.Table(
    ...
    sa.CheckConstraint(
        ...
        name="source_identity_snapshot_object",
    ),
    sa.CheckConstraint(
        "source_url_snapshot = btrim(source_url_snapshot) "
        "AND source_url_snapshot <> ''",
        name="source_url_snapshot_nonempty",
    ),
    sa.CheckConstraint(
    ...
    sa.CheckConstraint(
        ...
        name="sent_after_attempt",
    ),
    sa.UniqueConstraint(
        "recipient_chat_id",
        "source_id",
        name="uq_owner_source_candidate_notifications_recipient_source",
    ),
)
